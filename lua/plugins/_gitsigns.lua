return {
  ...
  keys = {
    ...
    { "<leader>g{", "<cmd>Gitsigns next_hunk<cr>", desc = "[Gitsigns] Moverse hacía el siguiente cambio que se ha realizado" },
    { "<leader>g}", "<cmd>Gitsigns prev_hunk<cr>", desc = "[Gitsigns] Moverse hacía el anterior cambio que se ha realizado" },
    ...
    { "<leader>gl", "<cmd>Gitsigns toggle_current_line_blame<cr>", desc = "[Gitsigns] Habilitar línea de cambios por usuario" },
