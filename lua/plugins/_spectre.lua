return {
  ...
  keys = {
    { "<leader>fs", "<cmd>lua require('spectre').open_file_search()<cr>",
      desc = "[Spectre] Buscar líneas desde el archivo" },
    { "<leader>fe", "<cmd>lua require('spectre').open_visual()<cr>",
      desc = "[Spectre] Buscar palabra en modo visual en todos los archivos" },
    { "<leader>fw", "<cmd>lua require('spectre').open_visual({select_word=true})<cr>",
