local opts = {
  ...
  { "n", "<c-up>", ":resize +2<cr>", "Redimensionar vista hacía arriba" },
  { "n", "<c-down>", ":resize -2<cr>", "Redimensionar vista hacía abajo" },
  { "n", "<c-left>", ":vertical resize -2<cr>", "Redimensionar vista hacía la izquierda" },
  { "n", "<c-right>", ":vertical resize +2<cr>", "Redimensionar vista hacía la derecha" },
